                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3 d-flex align-items-start">
                            ...
                            <span class="flex-grow-1">
                                Its Kernel continuously collects real-time and extra-high-precision flow states using a novel zero-control-plane overhead sFlow scheme (IEEE ICC 2026, to appear).
                            </span>
                        </li>
                        <li class="mb-3 d-flex align-items-start">
                            <div class="mt-1 me-3 flex-shrink-0" style="width: 24px; text-align: center;">
